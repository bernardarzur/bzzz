...
import ubinascii
import struct
w='RX_D74e'                                        #nom de la ruche, ou identifiant TTN, Lopy_d74e
configuration=1                                     #normalement positionné à 1, puisqu'on se place au RX pour écouter la ruche en configuration point à point, ne sert pas si on a une gateway TTN à portée   
debug=1                                                # normalement positionné à 0
wake=0                                                  # normalement positionné à 1; pas de deepsleep wake =0, période d'émission selon delai_local,  deepsleep -> wake =1, période d'émission selon sleepdebug=1, ne sert pas pour les RX
...
timeout=60000*10                                 # timeout  en millisecondes ; 60000 millisecondes font une minute
