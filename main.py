...
tare_50kg = 1.648802e+07#420000                                                     #lecture du capteur pedale sans rien dessus le 23/01/2017
etalon_50kg = 1550#5202                                                      #poids de l'étalon pedale en grammes
mesure_50kg = 1.650083e+07-tare_50kg #559000-tare_50kg                              #mesure du poids de l'étalon pedale en tenant compte de la tare     
...
if  configuration  in (110, 120,  106, 206, 306):
...
#     if carte_sd:
   #      sd = SD()
     ...
     for i in range (0, 10):
         ...
         lecture_capteur=acquisitionCapteur_2(tare_50kg, mesure_50kg,   etalon_50kg , nombre_point )  #fait l'acquisition sur le capteur 20 kg_ sur une moyenne de nombre_point
         poids_en_gr=(lecture_capteur-tare_50kg)/mesure_50kg*etalon_50kg
         t=temperatureLopy(GAIN_local,OFFSET_local)#mesure de la température du RX***************************************************************************
         print(" capteur_50kg : ",lecture_capteur,"**", poids_en_gr,"  Temperature : ", t)
         trame=trame+delimiteur+str(poids_en_gr)+delimiteur+str(lecture_capteur)
