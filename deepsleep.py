...
class DeepSleep:
    ...
    def __init__(self):
        ...
        self.clearbits(c.OPTION_REG_ADDR, 1 << 7)
    ...
    def calibrate(self):
        ...
        self._magic(c.CTRL_0_ADDR, 0xFF, 1 << 2, 0, 0)
        ...
        try:
            if len(self._pulses) > 6:
                self.clk_cal_factor = (self._pulses[6][1] - self._pulses[4][1]) / c.EXP_RTC_PERIOD
            else:
                self.clk_cal_factor = (self._pulses[5][1] - self._pulses[3][1]) / c.EXP_RTC_PERIOD
        except:
            pass
    ...
    def get_wake_status(self):
        ...
        wake_r = self.peek(c.WAKE_STATUS_ADDR)
    ...
    def set_min_voltage_limit(self, value):
        ...
        self.poke(c.MIN_BAT_ADDR, value)
    ...
    def go_to_sleep(self, seconds):
        ...
        while True:
            ...
            self.poke(c.SLEEP_TIME_ADDR, (seconds >> 16) & 0xFF)
            self.poke(c.SLEEP_TIME_ADDR + 1, (seconds >> 8) & 0xFF)
            self.poke(c.SLEEP_TIME_ADDR + 2, seconds & 0xFF)
            self.setbits(c.CTRL_0_ADDR, 1 << 0)

    def hw_reset(self):
        self.setbits(c.CTRL_0_ADDR, 1 << 4)
