...
mesure=c.mesure                                     #on corrige la mesure en enlevant la tare
i=0
while i  <=  8:
...
if configuration== 101: # ON VA CONFIGURER LE RX il y a 0 capteurs sur le RX; il y a un capteurs 20 kg sur le TX; 
